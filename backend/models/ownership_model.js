...
const ownership={
    ...
    updateOwnership:function(id, idownership,callback) {
        return db.query('UPDATE idownership SET idownership=?, user_iduser=?, account_idaccount=? WHERE idownership=?', [idownership.idownership, idownership.user_iduser, idownership.account_idaccount, id], callback);
    }
};
